...
# =============== 基础配置 ===============
st.set_page_config(
    page_title="DeepNovel 写作工厂（自动追字数版）",
    layout="wide",
    page_icon="📚"
)
...
# ======================================================
# 2. 章节写作工坊 —— 标题生成 + 正文 + 自动追字数 + 亮点
# ======================================================
elif tool.startswith("2"):
    st.header("2️⃣ 章节写作工坊 · 正文+自动追字数+亮点")
